package netdb.courses.softwarestudio.recommander.search;

import static org.junit.Assert.assertEquals;

import netdb.courses.softwarestudio.recommander.DefAnalyzer;
import netdb.courses.softwarestudio.recommander.document.Document;
import netdb.courses.softwarestudio.recommander.document.Field;
import netdb.courses.softwarestudio.recommander.document.RamField;
import netdb.courses.softwarestudio.recommander.index.IndexAccessException;
import netdb.courses.softwarestudio.recommander.index.IndexReader;
import netdb.courses.softwarestudio.recommander.index.IndexWriter;
import netdb.courses.softwarestudio.recommander.index.TrieIndexReader;
import netdb.courses.softwarestudio.recommander.index.TrieIndexWriter;
import netdb.courses.softwarestudio.recommander.search.IndexSearcher;
import netdb.courses.softwarestudio.recommander.search.MoreLikeThisQuery;
import netdb.courses.softwarestudio.recommander.search.Query;
import netdb.courses.softwarestudio.recommander.search.ScoreDoc;
import netdb.courses.softwarestudio.recommander.search.SingleFieldSortComparator;
import netdb.courses.softwarestudio.recommander.search.TopDocs;
import netdb.courses.softwarestudio.recommander.store.Directory;
import netdb.courses.softwarestudio.recommander.store.RamDirectory;
