...
import netdb.courses.softwarestudio.recommander.TermQueryAnalyzer;
import netdb.courses.softwarestudio.recommander.analysis.Analyzer;
import netdb.courses.softwarestudio.recommander.analysis.Token;
import netdb.courses.softwarestudio.recommander.analysis.TokenStream;
import netdb.courses.softwarestudio.recommander.index.DocInfo;
...
import netdb.courses.softwarestudio.recommander.index.TermInfo;
			...
			public List<ScoreDoc> score() {
				...
				try {
					while (stream.incrementToken()) {
						TermInfo ti = reader.termInfo(token.getTermBuffer(), token.getTermLength());
						if (ti == null)
							continue;
